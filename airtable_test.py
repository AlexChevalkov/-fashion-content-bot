...
Мы не сообщаем, что произошло. Мы объясняем, почему это важно и что это говорит о моде.

Задача:
Выбрать инфоповод не по громкости, а по потенциалу авторского экспертного комментария Александра Шуррона.
...
- стратегию индустрии;
- вкус / невкус;
- архив как инструмент;
- культурный контекст;
- бизнес-логику;
- визуальную власть образа.
